 ...
 *
 * The outcome VOCABULARY is not here: it lives in the portal's tour_outcomes
 * table and is read by ./outcomes.js, so a new outcome is a row rather than a
 * deploy.
 */
...
module.exports = { issueTicket, readTicket, TICKET_TTL_MS };
